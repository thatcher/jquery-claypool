var Claypool={
/**
 * Claypool 1.0.rc12 - A Web 1.6180339... Javascript Application Framework
 *
            ...
            if(proxyURL && proxyURL.length && proxyURL.length > 0){
                ...
                $.ajax({
                    ...
                    success: function(text){
                        _this.logger.debug("Got response for proxy. %s", text);
                        response.body = text;
                    },
                    ...
                    complete: function(xhr, status){
                        ...
                        response.headers["Content-Encoding"] = '';//proxyURL[0].payload.contentEncoding||;Content-Encoding
